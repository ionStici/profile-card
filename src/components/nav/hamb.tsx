...
export default function Hamb({ openNav }: HambProps) {
  return (
    <button
      ...
      transition duration-300 focus:outline-none hover:bg-slate-100 hover:shadow-inner hover:dark:bg-slate-700 hover:border-transparent ring-2 ring-transparent focus:ring-red-400 focus:border-transparent"
    >
